      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-6">
        ...
        {items.length === 0 ? (
          <div className="rounded-lg border border-dashed border-zinc-200 bg-white p-6 text-sm text-zinc-600">
            No pages were detected. If this project uses Next.js, make sure you have an{' '}
            <code>app/</code> or <code>pages/</code> directory. If it uses React Router, you can
            still type a path in the address bar.
          </div>
        ) : (
